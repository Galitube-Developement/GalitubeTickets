						...
						<div class="flex items-center gap-8">
							...
							<div>
								<p class="text-lg font-bold">
									Importing deletes all existing data!
								</p>
				...
				>
					<div>
						{#if submitted}
							...
							>
								<!-- Server log values are HTML-escaped before streaming. -->
								...
								<div class="my-4 flex flex-col items-center gap-4">
									...
									>
										...
										<div class="flex flex-col gap-2 leading-tight">
											...
											<span
												class="flex items-center gap-4 text-gray-500 dark:text-slate-400"
											>
											...
											{#if comment && !sameClient}
												<span
													class="flex items-center gap-4 text-orange-600 dark:text-orange-400"
												>
									...
									>
										...
										<div class="flex flex-col gap-2 leading-tight">
											...
											<span
												class="flex items-center gap-4 text-red-600 dark:text-red-400"
											>
											...
											{#if guild.stats.tickets > 0}
												...
												>
													...
													{guild.stats.tickets} tickets and their transcripts
													will be deleted
												</span>
											{/if}
											<div class="mt-4">
