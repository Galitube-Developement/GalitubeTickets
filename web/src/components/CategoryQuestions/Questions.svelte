...
<div bind:this={list} class="list-group flex flex-col gap-2">
	{#each qS.questions as q, i}
		<div
			data-id={q.id}
			class="list-group-item rounded-xl bg-gray-100/50 p-4 dark:bg-slate-800/50"
		>
			<div class="w-full">
				<div class="flex items-center gap-2 md:gap-4">
					<i
						class="handle fa-solid fa-grip-vertical cursor-move text-gray-500 dark:text-slate-400"
					></i>
					...
					<div class="w-full">
						...
						>
							<span class="text-sm">
								Click to {expanded === q.id ? 'collapse' : 'expand'}</span
							>
							<i
