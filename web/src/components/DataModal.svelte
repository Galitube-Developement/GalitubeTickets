		...
		>
			<div class="m-2 flex flex-col gap-6 sm:m-4">
				<div class="text-center">
					...
					<h4
						class="text-lg font-semibold leading-tight text-gray-500 dark:text-slate-400"
					>
						...
						<div class="flex items-center gap-2 md:gap-4">
							<div class="flex w-full items-center gap-4">
								...
								<div class="w-full">
									...
									<div class="text-sm">
										Overwrite all existing data with uploaded data
									</div>
								</div>
							</div>
						</div>
						...
						<div class="flex items-center gap-2 md:gap-4">
							<div class="flex w-full items-center gap-4">
								...
								<div class="w-full">
									...
									<div class="text-sm">
										Delete all settings, archives, and everything else
									</div>
								</div>
							</div>
						</div>
