								...
								<div class="flex items-center gap-2 md:gap-4">
									<div class="flex w-full items-center gap-4">
										...
										<div class="w-full">
											...
											>
												Ask questions and report problems in the Galitube
												Tickets repository.
											</div>
										</div>
									</div>
									...
									<div class="flex w-full items-center gap-4">
										...
										<div class="w-full">
											...
											<div
												class="text-sm font-medium text-gray-500 transition duration-300 group-hover:text-white dark:text-slate-400 dark:group-hover:text-white"
											>
												Read the documentation so you know exactly what to
												do and avoid time-wasting mistakes.
											</div>
										</div>
									</div>
								</div>
