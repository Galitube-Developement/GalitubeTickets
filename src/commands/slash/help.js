			...
			fields.unshift(
				{
					...
					value: [
						['commands', 'https://github.com/Galitube-Developement/GalitubeTickets#readme'],
						['docs', 'https://github.com/Galitube-Developement/GalitubeTickets#readme'],
						['feedback', 'https://github.com/Galitube-Developement/GalitubeTickets/issues'],
						['support', 'https://github.com/Galitube-Developement/GalitubeTickets/issues'],
					]
			...
			embeds: [
				new ExtendedEmbedBuilder({
					...
					.setDescription(staff
						? `**Galitube Tickets v${version} by Galitube Hosting.**`
