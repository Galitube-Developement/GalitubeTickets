				...
				.addFields([
					{
						...
						value: getMessage('misc.role_error.fields.for_admins.value', { url: 'https://github.com/Galitube-Developement/GalitubeTickets#readme' }),
					},
				]),
		);
				...
				.addFields([
					{
						...
						value: getMessage('misc.permissions_error.fields.for_admins.value', { url: 'https://github.com/Galitube-Developement/GalitubeTickets#readme' }),
					},
				]),
		);
	} else {
