 ...
 *
 * @name Galitube-Developement/GalitubeTickets
 * @description Galitube Hosting's Discord bot for ticket management
...
if (base_dir !== cwd) {
	...
	console.log(colours.blueBright('  Learn more at https://github.com/Galitube-Developement/GalitubeTickets/issues.'));
}
...
process.on('uncaughtException', (error, origin) => {
	log.notice(`Galitube Tickets v${pkg.version} on Node.js ${process.version} (${process.platform})`);
